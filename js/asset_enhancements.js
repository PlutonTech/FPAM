...
// // fetched from the API in the background.
...
//   if (!childId) { if(typeof toast==='function') toast('Enter a child asset ID', 'fa-triangle-exclamation', true); return; }
//   linkAssets(parentId, childId);
//   if(typeof toast==='function') toast(`Linked ${childId} as child`, 'fa-link');
