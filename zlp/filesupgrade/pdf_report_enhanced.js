...
<div class="header">
  <div class="logo-block">
    ...
    <div class="org">Federal Public Asset Maintenance Department</div>
...
<div class="footer">
  <span>Generated by AssetSpatial — Federal Public Asset Maintenance Department</span>
...
<div class="header">
  <div>
    ...
    <h1>${mdaName}</h1>
    <div style="font-size:12px;color:#5A6A7A;margin-top:4px">Federal Public Asset Maintenance Department</div>
  </div>
...
<div class="footer">
  <span>AssetSpatial — Federal Public Asset Maintenance Department</span>
  <span>${new Date().toLocaleString('en-NG')}</span>
</div>
</body></html>`;
...
<div class="header">
  ...
  <div style="font-size:12px;color:#5A6A7A;margin-top:4px">Generated: ${_fmtDate(new Date())} — Federal Public Asset Maintenance Department</div>
</div>
<div class="summary">
